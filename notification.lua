...
-- thanks chatgpt for converting my gui in normal shit!
    ...
    titleLabel.Text = title or "game notification"
    ...
    notificationText.Text = message or "notification placeholder"
